...
class Scraper:
                ...
                if len(tarefas) > 0 :    
                    ...
                    for tarefa in tarefas:
                        ...
                        if (tarefa['tarefa_tipo'] == "post"):
                            ...
                            if self.testando_header('realdanielribeiro', headers): 
                                ...
                                print(f'TESTE PARA {self.header_username} FALHOU. MUDANDO USERNAME')
    ...
    def extractFromPost(self, headers, base_url, post_url, tarefa_id, tag_id):
        ...
        try:
            ...
            # print(f'============= GER PROFILE - EXCEPTION -> HEADER TROCOU PARA {self.header_username} =================')
            # print(f' CURRENT HEADER {self.header_current}')
