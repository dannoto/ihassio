...
// Combina todas as partes para formar a URL completa
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="index.html" class="app-brand-link">
      ...
      <span class="app-brand-text   demo menu-text fw-bolder ms-2">Hássio</span><br><br>
  ...
  <li class="menu-item ">
    ...
    <li class="menu-item <?php if ("/ihassio/persona/categorias" == $uri || "/ihassio/persona/subcategorias" == $uri || "/ihassio/persona/intensidade" == $uri  || "/ihassio/persona/tags" == $uri  ) {echo "active";} ?>">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="<?= base_url() ?>persona/categorias" class="menu-link">
            <div data-i18n="Account">Categorias</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="<?= base_url() ?>persona/subcategorias" class="menu-link">
