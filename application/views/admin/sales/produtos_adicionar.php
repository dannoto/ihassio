...
>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="mb-3 mt-1">
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Produtos /</span> Adicionar</h4>
                    ...
                    <div class="card-body">
                      <form id="form-add-produto">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input  type="text" required name="nome" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input  type="text" required name="imagem" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input  type="number" required name="preco" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" required name="pagina_de_vendas" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
    ...
    $('#form-add-produto').on('submit', function(e) {
            e.preventDefault()
            ...
            $.ajax({
                method: 'POST',
                url: '<?= base_url() ?>sales/act_add_produto',
                data: form,
