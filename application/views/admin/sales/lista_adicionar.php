...
>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="mb-3 mt-1">
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Lista /</span> Adicionar</h4>
                    ...
                    <div class="card-body">
                      <form id="form-add-lista">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input  type="text" name="parentesco" value="" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
    ...
    $('#form-add-lista').on('submit', function(e) {
            e.preventDefault()
            ...
            $.ajax({
                method: 'POST',
                url: '<?= base_url() ?>sales/act_add_lista',
                data: form,
