...
>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="mb-3 mt-1">
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Campanha /</span> Editar</h4>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <input required type="hidden" name="id" value="<?= $campanha['id'] ?>" class="form-control" id="basic-default-name" placeholder="" />

                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">NOME</label>
                          <div class="col-sm-10">
                            <input required type="text" name="nome" value="<?= $campanha['nome'] ?>" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <textarea required name="descricao"  class="form-control"><?= $campanha['descricao'] ?></textarea>
                          </div>
                        </div>
    ...
    $('#form-update-campanha').on('submit', function(e) {
            ...
            $.ajax({
                method: 'POST',
                url: '<?= base_url() ?>sales/act_update_campanha',
                data: form,
