                  ...
                  <div class="card mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3 text-center card  m-1 mb-3 pt-3 mr-5 p-3 ">
                          <h2>R$ <?php $custo = round($email_data['sent']  * 0.003, 2); echo $custo; ?></h2>
                            <p>CUSTO</p>
                          </div>

                            
                          <div class="col-md-3 text-center card  m-1 mb-3 pt-3 mr-5 p-3 ">
                            <h2><?php $view = $email_data['uniqueViews']; echo $view; ?>  <span style="font-size: 10px;"><?php echo round(($email_data['uniqueViews']/$email_data['sent']), 2) * 100; ?>%</span></h2>
                            <p>VIEWS ÚNICAS</p>
                          </div>

                    
                          <div class="col-md-3 text-center card  m-1 mb-3 pt-3 mr-5 p-3 ">
                            <h2>R$ <?php $cpv = round(($custo / $view), 2); echo $cpv; ?></h2>
                            <p>CUSTO POR VIEW (CPV)</p>
                          </div>
                          <div class="col-md-3 text-center card  m-1 mb-3 pt-3 mr-5 p-3 ">
                            <h2>R$ <?php $cpm = round(($cpv * 1000), 2); echo $cpm; ?></h2>
                        ...
                        <div class="row">
                          <div class="col-md-3 text-center card  m-1 mb-3 pt-3 mr-5 p-3 ">
                              <h2><?php $cliques = $email_data['uniqueClicks']; echo $cliques; ?>  <span style="font-size: 10px;"><?php echo round(($email_data['uniqueClicks']/$email_data['sent']), 2) * 100; ?>%</span> </h2>
                              <p>CLIQUES</p>
                          </div>
                          <div class="col-md-3 text-center card  m-1 mb-3 pt-3 mr-5 p-3 ">
                            <h2>R$ <?php $cpv = round(($custo / $cliques), 2); echo $cpv; ?></h2>
                        ...
                        <div class="row">
                          <div class="col-md-3 text-center card  m-1 mb-3 pt-3 mr-5 p-3 ">
                              <h2><?php $vendas = count($this->admin_model->get_vendas_by_campanha($campanha['id'], 'email') ); echo $vendas;?></span> </h2>
                              <p>VENDAS POR E-MAIL</p>
                          </div>
                          <div class="col-md-3 text-center card  m-1 mb-3 pt-3 mr-5 p-3 ">
                            <h2>R$ <?php if ($vendas == 0) {echo $custo;} else {$cpa = round(($custo / $vendas), 2); echo $cpa;} ?></h2>
                            <p>CUSTO POR VENDAS (CPA)</p>
                          </div>

                          <div class="col-md-3 text-center card  m-1 mb-3 pt-3 mr-5 p-3 ">
                           
                            <h2>R$ <?php $faturamento = round($vendas *  $this->admin_model->get_produto($campanha['produto'])['preco'], 2); echo $faturamento; ?></h2>
                            <p>FATURAMENTO </p>
                          </div>
