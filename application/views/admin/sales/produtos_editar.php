...
>
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="mb-3 mt-1">
                <a href="<?= base_url() ?>sales/produtos">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form id="form-update-produto">
                        ...
                        <input  type="hidden" required name="id" value="<?= $produto['id'] ?>" class="form-control" id="basic-default-name" placeholder="" />

                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">NOME</label>
                          <div class="col-sm-10">
                            <input  type="text" required name="nome" value="<?= $produto['nome'] ?>" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input  type="text" required name="imagem" value="<?= $produto['imagem'] ?>" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input  type="number" required name="preco" value="<?= $produto['preco'] ?>" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select required name="plataforma" class="form-select"  >
                                <option value="">Selecionar </option>

                                <?php foreach ($this->admin_model->get_produto_plataformas() as $c) { ?>

                                    <?php if ($c->id == $produto['plataforma']) { ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select  required name="categoria" class="form-select"  >
                                <option value="">Selecionar </option>

                                <?php foreach ($this->admin_model->get_produto_categorias() as $c) { ?>
                                    <?php if ($c->id == $produto['categoria']) { ?>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" required name="pagina_de_vendas" value="<?= $produto['pagina_de_vendas'] ?>" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
    ...
    $('#form-update-produto').on('submit', function(e) {
            ...
            $.ajax({
                method: 'POST',
                url: '<?= base_url() ?>sales/act_update_produto',
                data: form,
                success: function(data) {
                    ...
                    if (resp.status == "true") {
                        ...
                        window.location.href = "<?= base_url() ?>sales/produtos"
