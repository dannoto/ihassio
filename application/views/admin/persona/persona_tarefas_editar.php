...
>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="mb-3 mt-1">
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tarefas /</span> Editar</h4>
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form id="form-update-tarefa">

                      <input type="hidden" value="<?=$t['id']?>" name="tarefa_id">

                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">NOME</label>
                          <div class="col-sm-10">
                            <input required type="text" value="<?=$t['tarefa_nome']?>" name="tarefa_nome" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <?php foreach ($this->admin_model->get_itens() as $c) { ?>
                                    <option <?php if ($t['tarefa_tag'] == $c->id) { echo "selected"; }?> value="<?=$c->id?>"><?=$c->nome?> - <?=$this->admin_model->get_categoria($c->categoria_id)['nome'] ?></option>
                                <?php } ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select required name="tarefa_tipo" class="form-select"  >
                                    <option value="">Selecionar</option>
                                    <option   <?php if ($t['tarefa_tipo'] == "post") { echo "selected"; }?> value="post">POST</option>
                                    <option  <?php if ($t['tarefa_tipo'] == "feed") { echo "selected"; }?> value="feed">FEED</option>
                                    <option  <?php if ($t['tarefa_tipo'] == "tag") { echo "selected"; }?> value="tag">TAG</option>
                                    <option  <?php if ($t['tarefa_tipo'] == "location") { echo "selected"; }?> value="location">LOCATION</option>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input required type="url" value="<?=$t['tarefa_url']?>" name="tarefa_url" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
    ...
    $('#form-update-tarefa').on('submit', function(e) {
            e.preventDefault()
            ...
            $.ajax({
                method: 'POST',
                url: '<?= base_url() ?>persona/act_update_tarefa',
                data: form,
