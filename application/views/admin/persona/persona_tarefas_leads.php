    ...
    <div class="d-flex justify-content-center">
                    <nav aria-label="..." class="mt-5 mb-5">
                        <ul class="pagination">
                            ...
                            <?php if ($atual > 3) {  ?>
                                <li class="page-item"><a class="page-link" href="<?= base_url() ?>sales/lista_leads/<?=$t['id']?>">Inicio</a></li>
                            <?php } ?>
                            <?php if ($atual > 1) {  ?>
                                <li class="page-item"><a class="page-link" href="<?= base_url() ?>sales/lista_leads/<?=$t['id']?>?p=<?= $anterior ?>">Anterior</a></li>
                            <?php } ?>
                            ...
                            <li class="page-item active bg-blue">
                                <a class="page-link" href="<?= base_url() ?>sales/lista_leads/<?=$t['id']?>?p=<?= $atual ?> "><?= $atual ?> <span class="sr-only"></span></a>
                            </li>

                            <?php if ($atual < $total_pages) {  ?>

                                <li class="page-item"><a class="page-link" href="<?= base_url() ?>sales/lista_leads/<?=$t['id']?>?p=<?= $proxima ?>"><?= $proxima ?></a></li>
                            ...
                            <?php if ($atual < $total_pages) {  ?>
                                <?php if ($atual >= 1) {  ?>
                                    <li class="page-item">
                                        <a class="page-link" href="<?= base_url() ?>sales/lista_leads/<?=$t['id']?>?p=<?= $proxima ?>">Próximo</a>
                                    </li>
                                <?php } ?>
                            <?php } ?>

                            <li class="page-item"><a class="page-link" href="<?= base_url() ?>sales/lista_leads/<?=$t['id']?>?p=<?= $total_pages ?>">Última</a></li>
