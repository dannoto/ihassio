                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex  align-items-center justify-content-between">
                        <div>
                        <H4>Leads - Filtro</H4>
                        <?php print_r($this->admin_model->coutx_inaptos($t['id']));?>
                        <p> <small>INAPTOS: <?=count($this->admin_model->coutx_inaptos($t['id']))?> | APTOS: <?=count($this->admin_model->coutx_aptos($t['id']))?> | CONVERTIDOS: <?=count($this->admin_model->coutx_convertidos($t['id']))?>  </small>    </p>
                            <p><?= $t['tarefa_nome'] ?></p>
