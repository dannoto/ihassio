                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex  align-items-center justify-content-between">
                        <div>
                        <H4>Leads - Filtro</H4>
                        <p> <small>INAPTOS: <?=count($this->admin_model->coutxinaptos($t['id']))?> | APTOS: <?=count($this->admin_model->coutxaptos($t['id']))?> | CONVERTIDOS: <?=count($this->admin_model->coutxconvertidos($t['id']))?>  </small>    </p>
                            <p><?= $t['tarefa_nome'] ?></p>
