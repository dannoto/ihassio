        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Persona /</span> Categorias</h4>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">Nova Categoria</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                        ...
                        <div class="modal fade" id="modalEditar" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <form id="form-update-categoria" action="">
                                <input type="hidden"  name="id" id="update_categoria_id">
                                  <div class="row">
                                      <div class="col mb-3">
                                        <label for="nameBasic" class="form-label">Nome</label>
                                        <input type="text" name="nome" id="update_categoria_nome" class="form-control"  />
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col mb-3">
                                        <label for="nameBasic" class="form-label">Slug</label>
                                        <input type="text" name="slug" id="update_categoria_slug" class="form-control"  />
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col mb-3">
                                        <label for="nameBasic" class="form-label">Descriçao</label>
                                        <input type="text" name="descricao" id="update_categoria_descricao" class="form-control"  />
                                      </div>
                                    </div>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a onclick="get_categoria(<?=$c->id?>) " class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalEditar" href="javascript:void(0);"
      ...
      $.ajax({
        ...
        function delete_categoria(categoria_id) {
          ...
          if (resposta === true) {
              ...
              $.ajax({
                          method: 'POST',
                          url: '<?= base_url() ?>persona/act_delete_categoria',
                          data: {categoria_id:categoria_id},
                          success: function(data) {
                              var resp = JSON.parse(data)
