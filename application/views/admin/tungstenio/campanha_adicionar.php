                        ...
                        <div class="row" id="div-publico-idade" style="display: none;">
                            <div class="col-md-6">
                              <label for="html5-date-input" class="col-md-2 col-form-label">IDADE MAX. </label>
                                <input  type="text" name="campanha_publico_idade_max" class="form-control" id="basic-default-name" placeholder="" />
                            </div>
                            <div class="col-md-6">
                                <label for="html5-date-input" class="col-md-2 col-form-label">IDADE MIN. </label>
                                <input  type="text" name="campanha_publico_idade_min" class="form-control" id="basic-default-name" placeholder="" />
                            </div>
                        </div>
