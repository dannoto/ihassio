...
>
  ...
  <body>
                    ...
                    <div class="card-body">
                      <form id="form-add-produto">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input  type="text" required name="produto_nome" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input  type="text" required name="produto_imagem" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input  type="number" required name="produto_preco" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" required name="produto_pagina_de_vendas" class="form-control" id="basic-default-name" placeholder="" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <textarea name="produto_descricao" id=""  class="form-control"></textarea>
                          </div>
                        </div>
    ...
    $('#form-add-produto').on('submit', function(e) {
            ...
            $.ajax({
                method: 'POST',
                url: '<?= base_url() ?>tungstenio/act_add_produto',
                data: form,
