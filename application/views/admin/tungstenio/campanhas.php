        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <!-- <div class="mb-3 mt-1">
              ...
              <a href="<?= base_url() ?>tungstenio/campanha_adicionar">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        ...
                        <?php
                          ...
                          if ($c->campanha_status == "1"){ 
                            echo "<span class='badge badge-primary' style='background: gray; color: #FFF' ><small>RASCUNHO</small></span>"; } 
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a  class="dropdown-item" href="<?= base_url() ?>tungstenio/campanha_editar/<?= $c->id ?>"
