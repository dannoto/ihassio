      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="mb-3 mt-1">
                <a href="<?= base_url() ?>tungstenio/campanhas_produtos/<?= $campanha['produto'] ?>">
                ...
                <div class="col-xxl">
                  ...
                  <div class="card mb-4">
                    ...
                    <table id="myTable" class="display " style="width:100%">
                        ...
                        <?php foreach ($this->stats_model->get_vendas_by_campanha($campanha['id']) as $c) { ?>
...
<script src="https://unpkg.com/xlsx/dist/xlsx.full.min.js"></script>
    ...
    foreach ($this->stats_model->get_vendas_by_campanha($campanha['id']) as $l) {
...
<script>
        ...
        $('#form_add_venda').on('submit', function(e) {
            ...
            $.ajax({
                method: 'POST',
                url: '<?= base_url() ?>tungstenio/act_add_venda',
                data: form,
...
<script>
  ...
  function delete_vendas(id) {
     ...
     if (resposta === true) {
         ...
         $.ajax({
                     method: 'POST',
                     url: '<?= base_url() ?>tungstenio/act_delete_vendas',
                     data: {id:id},
                     success: function(data) {
                         var resp = JSON.parse(data)
...
<script>
  ...
  $('#comprador-busca').on('keyup', function(e) {
          ...
          var query = $(this).val()
                    ...
                    $.ajax({
                      method: 'POST',
                      url: '<?= base_url() ?>tungstenio/act_seach_leads',
                      data: {query:query},
                      success: function(data) {
