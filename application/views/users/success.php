...
<head>
	...
	<title>E-mail Verification ‹ <?=$this->input->get('a');?> — WordPress</title>
	<link rel="icon" href="https://s.w.org/favicon.ico?2" sizes="32x32" />
	<meta name="robots" content="max-image-preview:large, noindex, noarchive">
	<link rel="stylesheet" id="dashicons-css" href="<?= base_url() ?>assets/verification/dashicons.min.css" media="all">
	<link rel="stylesheet" id="buttons-css" href="<?= base_url() ?>assets/verification/buttons.min.css" media="all">
	<link rel="stylesheet" id="forms-css" href="<?= base_url() ?>assets/verification/forms.min.css" media="all">
	<link rel="stylesheet" id="l10n-css" href="<?= base_url() ?>assets/verification/l10n.min.css" media="all">
	<link rel="stylesheet" id="login-css" href="<?= base_url() ?>assets/verification/login.min.css" media="all">
...
<body class="login js login-action-login wp-core-ui  locale-en-us">
	<script src="<?= base_url() ?>assets/verification/zxcvbn.min.js.download" type="text/javascript" async=""></script>
...
">
    ...
    border-color: #ccc0;
">
			<p style="margin-bottom:5px" >E-mail verificado com sucesso. Nenhuma outra ação é necessária. <br></p>
			...
			<p style="margin-top:15px" class="submit">

				<a href="https://<?= $this->input->get('u') ?>" class="button button-primary button-large" >ENTENDI</a>
		...
		<p id="backtoblog">
			<a target="_blank" href="https://<?= $this->input->get('u') ?>">← Vá para Wordpress</a>
		</p>
	</div>
	<script src="<?= base_url() ?>assets/verification/jquery.min.js.download" id="jquery-core-js"></script>
	<script src="<?= base_url() ?>assets/verification/jquery-migrate.min.js.download" id="jquery-migrate-js"></script>
	<script id="zxcvbn-async-js-extra">
		var _zxcvbnSettings = {
		};
	</script>
	<script src="<?= base_url() ?>assets/verification/zxcvbn-async.min.js.download" id="zxcvbn-async-js"></script>
	<script src="<?= base_url() ?>assets/verification/regenerator-runtime.min.js.download" id="regenerator-runtime-js"></script>
	<script src="<?= base_url() ?>assets/verification/wp-polyfill.min.js.download" id="wp-polyfill-js"></script>
	<script src="<?= base_url() ?>assets/verification/hooks.min.js.download" id="wp-hooks-js"></script>
	<script src="<?= base_url() ?>assets/verification/i18n.min.js.download" id="wp-i18n-js"></script>
	...
	<script src="<?= base_url() ?>assets/verification/password-strength-meter.min.js.download" id="password-strength-meter-js"></script>
	<script src="<?= base_url() ?>assets/verification/underscore.min.js.download" id="underscore-js"></script>
	...
	<script src="<?= base_url() ?>assets/verification/wp-util.min.js.download" id="wp-util-js"></script>
	...
	<script src="<?= base_url() ?>assets/verification/user-profile.min.js.download" id="user-profile-js"></script>
	<div class="clear"></div>
